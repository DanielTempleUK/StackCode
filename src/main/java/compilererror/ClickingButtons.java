...
public class ClickingButtons implements PacketType {
	...
	public void processPacket(final Client c, final int packetType, final int packetSize) {
		...
		case 26018:
			final Client o = PlayerHandler.players[c.duelingWith];
			if (o == null) {
		...
		case 25120:
			...
			final Client o1 = PlayerHandler.players[c.duelingWith];
			if (o1 == null) {
				c.getTradeAndDuel().declineDuel();
				return;
			}
		...
		case 4171:
		case 50056:
			final String type = c.playerMagicBook == 0 ? "modern" : "ancient";
		...
		case 13092:
			...
			final Client ot = PlayerHandler.players[c.tradeWith];
			if (ot == null) {
		...
		case 13218:
			...
			final Client ot1 = PlayerHandler.players[c.tradeWith];
			if (ot1 == null) {
				c.getTradeAndDuel().declineTrade();
				c.sendMessage("Trade declined as the other player has disconnected.");
				break;
		...
		case 82024: // Deposit equipment
			for (int i = 0; i < c.playerEquipment.length; i++) {
				...
				final int itemAmount = c.playerEquipmentN[i];
